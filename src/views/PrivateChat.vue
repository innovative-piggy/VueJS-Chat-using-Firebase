<template>
    <div class="container">
        ...
        <button @click="logout" class="btn btn-success mb-1">logout</button>
        <div class="messaging">
            <div class="inbox_msg">
                ...
                <div class="mesgs">
                    <div class="msg_history">
                        ...
                        >
                            ...
                            >
                                <img :src="message.avatar" alt="sunil" />
                            </div>
                            <div
                                :class="[message.author == authUser.displayName ? 'sent_msg' : 'received_msg']"
                            >
                                <div
                                    :class="[message.author == authUser.displayName ? 'sent_withd_msg' : 'received_withd_msg']"
                                >
            ...
            <p class="text-center top_spac">
                Design by
                <a target="_blank" href="#">Innovative-Piggy</a>
            </p>
        </div>
    </div>
</template>
